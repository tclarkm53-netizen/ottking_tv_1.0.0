...
public class AppPreferences {
    ...
    public String getBufferSettings() {
        return prefs.getString("buffer_settings", "Instant / Zero Lag (< 100ms)");
    }
    ...
    public String getHlsSettings() {
        return prefs.getString("hls_settings", "Ultra Fast (Chunkless)");
    }

    public void setHlsSettings(String hlsSetting) {
        prefs.edit().putString("hls_settings", hlsSetting).apply();
    }

    public String getMpdSettings() {
        return prefs.getString("mpd_settings", "Low Latency (Fast Sync)");
    }

    public void setMpdSettings(String mpdSetting) {
        prefs.edit().putString("mpd_settings", mpdSetting).apply();
    }

    public boolean isHlsChunklessEnabled() {
        return prefs.getBoolean("hls_chunkless_enabled", true);
    }

    public void setHlsChunklessEnabled(boolean enabled) {
        prefs.edit().putBoolean("hls_chunkless_enabled", enabled).apply();
    }
