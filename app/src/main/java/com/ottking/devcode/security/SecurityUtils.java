...
public class SecurityUtils {
    ...
    public static String getXAppClientToken() { return Config.getXAppClientToken(); }
    ...
    public static final String APP_ID = "com.ottking.devcode";
    ...
    public static final String HEADER_EDGE_COOKIE = "Edge-Cookie";
    ...
    public static final String DEBUG_X_APP_CLIENT = Config.getXAppClientToken();
