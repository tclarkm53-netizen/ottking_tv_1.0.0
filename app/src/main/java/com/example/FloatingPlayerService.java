...
public class FloatingPlayerService extends Service {
    ...
    public static final String ACTION_START_FLOATING = "com.example.action.START_FLOATING";
    public static final String ACTION_STOP_FLOATING = "com.example.action.STOP_FLOATING";
    ...
    private void setupDragListener() {
        ...
        View header = floatingView.findViewById(R.id.floatingHeader);
        ...
        if (txtTitle != null) {
            txtTitle.setOnTouchListener(touchListener);
        }
    }
