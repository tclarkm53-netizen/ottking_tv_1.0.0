...
import com.example.network.IptvApiService;
...
public class ServerApiManager {
    ...
    public interface NotificationSyncCallback {
        void onSuccess(List<com.example.model.NotificationModel> notifications, int newCount);
        void onError(String errorMessage);
    }
        ...
        executor.execute(() -> {
            try {
                ...
                if (retrofitResponse.isSuccessful() && retrofitResponse.body() != null) {
                    ...
                    List<com.example.model.NotificationModel> list = new ArrayList<>();
                    int newItemsCount = 0;
